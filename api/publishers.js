// Vercel Serverless Function - Publishers Proxy
...
export default async function handler(req, res) {
    ...
    try {
        ...
        if (req.query.id) params.append('id', req.query.id);
        if (req.query.domain) params.append('domain', req.query.domain);
        ...
        const response = await fetch(`${SINCERA_API_BASE}/publishers${queryString}`, {
            method: 'GET',
            headers: {
